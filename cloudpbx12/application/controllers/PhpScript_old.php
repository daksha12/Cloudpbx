...
class PhpScript extends MY_Controller
{
  ...
  { 
    ...
    $old = ["#include trunk.conf", ";domain details company wise"];
    $new   = ["", "", ""];
    ...
    if(!empty($branchData)){
     ...
     foreach ($trunkData as $trunk) {
      $trunk_host .= 'domain='.gethostbyname($trunk->host).','.$trunk->domain.'_incoming  ;'.$trunk->tenant_name."\n\n";  
     }
  ...
  /******* SIP.CONF FILE *******/    
    ...
    if(!empty($trunkData)){
      ...
      foreach ($trunkData as $trunk) {
        ...
        $trunk_did = fopen("/etc/asterisk/trunk_".$trunk->trunk_did.".conf", "w") or die("Unable to open file!");
        ...
        $trunk_log_details .= "canreinvite=yes"."\n";
    ...
    if(!empty($extensionData)){
      ...
      if(!empty($trunkDIDData)){
        foreach ($trunkDIDData as $data) {
         if($data->did_type == 'extension' AND $data->extension != ''){
         ...
         if($data->did_type == 'conference' AND $data->extension != ''){
    ...
    if(!empty($extensionData)){ 
      ...
      $ext_user ='';
      //////  softphone_prefix ///////
      $ext_user .= "\n"."[".$prefix->softphone_prefix.$ext_data->extension."-".$ext_data->site_name."-".$ext_data->tenant_name."]"."\n";
      $ext_user .= "accountcode=".$accountCode."\n";
      $ext_user .= "type=friend"."\n";
      $ext_user .= "host=dynamic"."\n";
      $ext_user .= "defaultuser=".$prefix->softphone_prefix.$ext_data->extension."-".$ext_data->site_name."-".$ext_data->tenant_name."\n";
      ...
      //////  mobile_prefix ///////
      $ext_user .= "\n"."[".$prefix->mobile_prefix.$ext_data->extension."-".$ext_data->site_name."-".$ext_data->tenant_name."]"."\n";
      $ext_user .= "accountcode=".$accountCode."\n";
      $ext_user .= "type=friend"."\n";
      $ext_user .= "host=dynamic"."\n";
      $ext_user .= "defaultuser=".$prefix->mobile_prefix.$ext_data->extension."-".$ext_data->site_name."-".$ext_data->tenant_name."\n";
      $ext_user .= "secret=".$pass."\n";
      $ext_user .= "disallow=all"."\n";
      $ext_user .= "allow=g729"."\n";
      $ext_user .= "allow=ulaw"."\n";
      ...
      //////  desktop_prefix ///////
      $ext_user .= "\n"."[".$prefix->desktop_prefix.$ext_data->extension."-".$ext_data->site_name."-".$ext_data->tenant_name."]"."\n";
      $ext_user .= "accountcode=".$accountCode."\n";
      $ext_user .= "type=friend"."\n";
      $ext_user .= "host=dynamic"."\n";
      $ext_user .= "defaultuser=".$prefix->desktop_prefix.$ext_data->extension."-".$ext_data->site_name."-".$ext_data->tenant_name."\n";
      $ext_user .= "secret=".$pass."\n";
      $ext_user .= "disallow=all"."\n";
      $ext_user .= "allow=g729"."\n";
      $ext_user .= "allow=ulaw"."\n";
    ...
    /****** OUTGOING CALL DETAILS FILE *********/
      if(!empty($branchData)){
        ...
        ; to check and route for speed dial 
        exten => _XXXX,1,GotoIF($[${DB_EXISTS(SPD_'.$branch_data->tenant_name.'_'.$branch_data->site_name.'/${EXTEN})}]?spddial:) 
        ...
        exten => _XXX,1,GotoIF($[${DB_EXISTS(SPD_'.$branch_data->tenant_name.'_'.$branch_data->site_name.'/${EXTEN})}]?spddial:) 
        ...
        exten => _XX,1,GotoIF($[${DB_EXISTS(SPD_'.$branch_data->tenant_name.'_'.$branch_data->site_name.'/${EXTEN})}]?spddial:) 
        ...
        ;; here we define rules for outgoing calls 
        ...
        $monitoring = '['.$branch_data->tenant_name.'_'.$branch_data->site_name.'_callmonitor'.$ext.']
          ...
          exten => '.$ext.'222,n,Wait(1) 
          exten => '.$ext.'222,n,ChanSpy(SIP/${NUM}-'.$branch_data->site_name.'-'.$branch_data->tenant_name.',q) 
          ...
          exten => '.$ext.'223,n,Wait(1) 
          exten => '.$ext.'223,n,ChanSpy(SIP/${NUM}-'.$branch_data->site_name.'-'.$branch_data->tenant_name.',qw) 
         ...
         ;Barge ChanSpy(SIP/,qB) 
          ...
          exten => '.$ext.'224,n,Wait(1) 
          exten => '.$ext.'224,n,ChanSpy(SIP/${NUM}-'.$branch_data->site_name.'-'.$branch_data->tenant_name.',qB) 
        ...
        exten => '.$ext.'800,1,Set(_PARKINGLOT='.$branch_data->tenant_name.'_parking)
