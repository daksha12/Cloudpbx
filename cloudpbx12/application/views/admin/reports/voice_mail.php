...
==================================-->
  ...
  <select class="mdb-select md-form md-outline colorful-select dropdown-primary" name="extension" required="">
  <option value="" disabled selected>Choose Extension </option>
  <?php foreach ($extension_list as  $value) { ?>
  <option value="<?php echo $value->extension ?>,<?php echo $value->site_id ?>" <?php if($extension == $value->extension) {echo "selected";} ?>><?php echo $value->extension ?></option>
  <?php } ?>
  </select>
