    ...
    <i class="fas fa-user-tie" aria-hidden="true"></i> User    
    </h2>
    </div>
    ...
    <form method="post" action="Agentlogin" class="needs-validation" novalidate="" autocomplete="off">
    ...
    <?php  
     if ($this->session->flashdata('error')) {  ?>
      <p class="note note-danger col-md-12 mt-2" id='msg'><strong>Error :</strong> <?php echo $this->session->flashdata('error'); 
     }
    ?> 
